                  ...
                  <form id="contact-form" action="" method="post" enctype="multipart/form-data">
                    <fieldset>
                      <?php 
							...
							$sql="select * from upload_recipes where categry='$cat_details'";
						...
						?>	<ul>
							<li>
		<a href="cat_details1.php?sname=<?php echo $row[1] ?>"><img src="student_registration/upload/<?php echo $row[5]; ?>" style="width:160px; height:140px;" alt="Image"></a>
								<div>
									<h2><?php echo $row[1]; ?></h2>
									<p align="justify">Uploaded By <?php echo $row[2]; ?> &emsp; &emsp; <?php echo $row[3]; ?>																		
									<span style="text-align:right;"><a style="text-decoration:none" href="cat_details1.php?sname=<?php echo $row[1] ?>">Read more . . .</a></span></p>
								</div>
							</li>
						</ul>	
						<?php
