                    ...
                    <div class="col-lg-12 col-md-4">
                        <div class="panel panel-primary">
						  ...
						  <div class="form-group">
							...
							<input type="text" class="form-control" id="exampleInputEmail1" name="rec_name" placeholder="Equipment Name" required />
						  </div>						  						 
						  
						  
						  <div class="form-group">
							<label for="exampleInputEmail1">Equipment Image : *</label>
							<input type="file" class="form-control" id="exampleInputEmail1" name="rec_image" placeholder="Equipment Image" required />
						  </div>
						  ...
						  <div class="form-group">
                            ...
                            <div class="panel-footer">
                                <button type="submit" class="btn btn-success">Upload Equipment</button>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									<?php
											...
											$sql="select * from uploadrecipe_1";
