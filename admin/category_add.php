                    ...
                    <div class="module-table-body">
						...
						<?php
							...
							if($row=mysql_fetch_array($result))
								echo "Category id already exists";
							else

							{
								if($_FILES['photo1']['error']<=0)
								{
									...
									$ftype1=$_FILES['photo1']['type'];
									$fsize1=$_FILES['photo1']['size'];
									$ftmp1=$_FILES['photo1']['tmp_name'];
									move_uploaded_file($ftmp1,"upload/$fname1");
											
								}
					
						
								$sql="insert into category values('$id','$cname','upload/$fname1','$des')";
