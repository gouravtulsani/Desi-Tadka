            ...
            <div class="grid_12">
                ...
                <div class="module" align="center">
                    ...
                    <div class="module-table-body">
                    	<form action="changepass2.php" method="post" enctype="multipart/form-data">
                        
						
                        	<div class="form">
								<p>
									<label>Old Password<span>(Required)</span></label>
									<input type="password" class="field size1" name="txtpass1" />
								</p>	
								
								<p>
									<label>New Password<span>(Required)</span></label>
									<input type="password" class="field size1" name="txtpass2" />
								</p>
								
								<p>
									<label>RetypeNew Password<span>(Required)</span></label>
									<input type="password" class="field size1" name="txtpass3" />
								</p>
