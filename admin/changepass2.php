            ...
            <div class="grid_12">
                ...
                <div class="module">
					...
					include "connect.php";
						...
						$opass=$_POST['txtpass1'];
						
						$npass=$_POST['txtpass2'];
						
						$rtpass=$_POST['txtpass3'];
					...
					{
					$sql="select * from login where uname='$uname' and pass='$opass'";
					$result=mysql_query($sql);
					
					if($row=mysql_fetch_array($result))
					{
					$sql="delete from login where pass='$opass'";
					
					
					mysql_query($sql);
					
					$sql="insert into login values('$uname','$npass')";
