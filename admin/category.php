	...
	<body>
		...
		<div class="container_12">
                ...
                <div class="module">
                        ...
                        <table>
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:05%">Name</th>
                                    <th style="width:05%">Image</th>
                                    <th style="width:20%">Description</th>
									<th style="width:06%">Content Control</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
					...
					?>
                                <tr>
                                    ...
                                    <td align="center"><img src='<?php echo $row[2]; ?>' height=70 width=70 /></td>
            ...
            <div class="grid_12">
                ...
                <div class="module">
                     <h2><span>Insert Gallary</span></h2>
                     ...
                     <div class="module-body">
                        <form action="category_add.php" method="post" enctype="multipart/form-data">
                            ...
                            <p>
                                ...
                                <input type="text" class="input-short" name="txtid"/>
                                
                            </p>
                            
                            <p>
                                <label>Category Name</label>
                                <input type="text" class="input-medium" name="txtname" />
                            ...
                            <p>
                                ...
                                <textarea rows="7" cols="90" class="input-short" name="des"></textarea>
                            </p>
