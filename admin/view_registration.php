	...
	<body>
                    ...
                    <div class="grid_12">
                        <div id="logo">
                            <ul id="nav">
                                ...
                                <li><a href="view_registration.php" class="active">View Registration</a></li>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
                ...
                <!-- Example table -->
                <div class="module">
                	<h2><span>View Registration</span></h2>
					...
					?>
                      ...
                      <td>  <a href="delete_registration.php?sno=<?php echo $row[0]; ?>">Delete</a>
                                   </td>     
