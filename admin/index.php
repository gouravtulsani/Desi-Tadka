	...
	<body>
                ...
                <div class="container_12">
                    <div class="grid_12">
                        <div id="logo">
                            ...
                            <ul id="nav" >
                                <h1><font color="#FFFFFF">Recipes Admin Pannel</font></h1>
                            </ul>
                        </div><!-- End. #Logo -->
                    </div><!-- End. .grid_12-->
                    <div style="clear: both;"></div>
		...
		<div class="container_12">
            ...
            <div class="grid_12">
                ...
                <div class="module" align="center">
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                        	...
                        	<div class="form">
								<p>
									<label>User Id(Required)</span></label>
									<input type="text" class="field size1" name="txtname" />
								</p>	
								
								<p>
									<label> Password<span>(Required)</span></label>
									<input type="password" class="field size1" name="txtpass" />
								</p>
                ...
                <center><a href="../index.php"><input type="button" value="Home Website" style="display: inline-block; border-radius: 4px; background-color: #f4511e; border: none; color: #FFFFFF; text-align: center; font-size: 28px; padding: 10px; width: 250px; transition: all 0.5s; cursor: pointer; margin: 5px;" /></a></center>
