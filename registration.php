                   ...
                   <form id="contact-form" action="register_validate.php" method="post" enctype="multipart/form-data">
                    <fieldset>
                      <label><span class="text-form">Name:</span>
                        <input name="txtname" type="text" class="span2" />
                      </label>
					  <br>
                      <label><span class="text-form">Age:</span>
                        <input name="txtage" type="text" class="span2" />
                      </label>
					  <br>
					  
					  <label><span class="text-form">Email-Id:</span>
                        <input name="txtmail" type="text" class="span2"  />
                      </label>
					  <br>
					  
					  <label><span class="text-form">Password:</span>
                        <input name="txtpassword" type="password" class="span2" />
                      </label>
                      ...
                      <div class="wrapper">
                        ...
                        <div class="extra-wrap">
                          ...
                          <div class="clear"></div>
                          <div class="buttons"> 
		<input type="submit" value="Save" style="background-color: #4CAF50; color: white; padding: 5px 5px; margin: 5px 0; border: none; border-radius: 3px; cursor: pointer;" /> 
