            ...
            <article class="col-1">
              <div class="indent-left">
                <div>
							...
							?>
								<li>
									<h3><font style="text-transform:uppercase"><?php echo $row[1] ?></font></h3>
									<center><iframe width="560" height="315" src="<?php echo $row[3] ?>" frameborder="0" allowfullscreen></iframe></center>

									<p align="justify"> <?php echo $row[2] ?></p>
